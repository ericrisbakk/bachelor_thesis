package main.dataGeneration;/* Generated By:JavaCC: Do not edit this line. TreeContractTokenManager.java */
...
/** Token Manager. */
public class TreeContractTokenManager implements TreeContractConstants
{
...
/** Constructor. */
public TreeContractTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public TreeContractTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
